...
keytool -import -trustcacerts -alias htrc-ca -file /devenv_certs/certs/ca.cert.pem -keystore /usr/java/jdk1.8.0_131/jre/lib/security/cacerts -storepass changeit -noprompt
