...
keytool -import -trustcacerts -alias htrc-ca -file /devenv_sources/Analytics-Gateway/conf/HTRC-CA.crt -keystore /usr/java/jdk1.8.0_131/jre/lib/security/cacerts -storepass changeit -noprompt
keytool -import -trustcacerts -alias htrc-ca -file /devenv_sources/Analytics-Gateway/conf/HTRC-CA.crt -keystore /usr/share/wso2is/repository/resources/security/client-truststore.jks -storepass wso2carbon -noprompt
